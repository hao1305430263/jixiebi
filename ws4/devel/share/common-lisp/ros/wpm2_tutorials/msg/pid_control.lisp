...
(cl:defmethod sign-val ((m <pid_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wpm2_tutorials-msg:sign-val is deprecated.  Use wpm2_tutorials-msg:sign instead.")
  (sign m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<pid_control>)))
  ...
  "75b9d16766039ffd6652003c252e1822")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'pid_control)))
  "Returns md5sum for a message object of type 'pid_control"
  "75b9d16766039ffd6652003c252e1822")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<pid_control>)))
  ...
  (cl:format cl:nil "float32 speedH~%float32 speedW~%float32 degreeH~%float32 degreeW~%bool sign~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'pid_control)))
  "Returns full string definition for message of type 'pid_control"
  (cl:format cl:nil "float32 speedH~%float32 speedW~%float32 degreeH~%float32 degreeW~%bool sign~%~%~%"))
